...
public class OI {
    ...
    public JoystickButton alignToTopGoal;
    ...
    public OI() {
        ...
        alignToTopGoal = new JoystickButton(driver, 6);
        alignToTopGoal.whileHeld(new VisionAlignToTopGoal());
        ...
        SmartDashboard.putData("VisionAlignToTopGoal", new VisionAlignToTopGoal());
        ...
        SmartDashboard.putData("VisionOff", new VisionOff());
