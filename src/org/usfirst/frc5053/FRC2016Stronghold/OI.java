...
public class OI {
    ...
    public JoystickButton extendSolenoid;
    ...
    public OI() {
        ...
        extendSolenoid = new JoystickButton(operator, 3);
        extendSolenoid.whileHeld(new SolenoidExtend());
        ...
        SmartDashboard.putData("AutonForward: default", new AutonForward(50));
        ...
        SmartDashboard.putData("SolenoidExtend", new SolenoidExtend());
