...
public class OI {
    ...
    public Joystick driverThirdLayout;
    ...
    public OI() {
    	...
    	driverThirdLayout = new Joystick(4);
    	driverSecondLayout = new Joystick(3);
    	debugJoystick = new Joystick(2);
        operator = new Joystick(1);
        driver = new Joystick(0);
        
        fieldOrientToPOVButtons = new JoystickButton(driverThirdLayout, rightBlackButton);
        fieldOrientToPOVButtons.whileHeld(new DriveRotateFieldOrientation());
        AlignToLowGoalAndShoot = new JoystickButton(driverThirdLayout, leftShoulder);
        AlignToLowGoalAndShoot.whileHeld(new AlignToLowGoalAndShoot());
        //alignAndShootHighGoal = new JoystickButton(driverThirdLayout, rightShoulder);
        //alignAndShootHighGoal.whileHeld(new AlignAndShootHigh());
        kickerDriver = new JoystickButton(driverThirdLayout, B);
        kickerDriver.whileHeld(new ScalerReachUp());
        joystickButton1 = new JoystickButton(driverThirdLayout, Y);
        joystickButton1.whenReleased(new ShooterSpin(0));
        spinKickShooter = new JoystickButton(driverThirdLayout, Y);
        spinKickShooter.whileHeld(new PneumaticsShooterKick());
        shooterOff = new JoystickButton(driverThirdLayout, B);
        shooterOff.whenReleased(new ShooterSpin(0));
        //shooter = new JoystickButton(driverThirdLayout, 2);
        //shooter.whileHeld(new ShooterSpin(2000));
        driveStrightPID = new JoystickButton(driverThirdLayout, X);
        driveStrightPID.whileHeld(new ArcadeDriveStrightPID());
        shooterSlow = new JoystickButton(driverThirdLayout, A);
        shooterSlow.whileHeld(new ShooterSpin(-1500));
    	
    	
        
        //fieldOrientToPOVButtons = new JoystickButton(driverSecondLayout, 8);
        //fieldOrientToPOVButtons.whileHeld(new DriveRotateFieldOrientation());
    	AlignToLowGoalAndShoot = new JoystickButton(driverSecondLayout, 7);
    	AlignToLowGoalAndShoot.whileHeld(new AlignToLowGoalAndShoot());
        //alignAndShootHighGoal = new JoystickButton(driverSecondLayout, 8);
        //alignAndShootHighGoal.whileHeld(new AlignAndShootHigh());
        kickerDriver = new JoystickButton(driverSecondLayout, 6);
        kickerDriver.whileHeld(new ScalerReachUp());
        joystickButton1 = new JoystickButton(driverSecondLayout, 4);
        joystickButton1.whenReleased(new ShooterSpin(0));
        spinKickShooter = new JoystickButton(driverSecondLayout, 4);
        spinKickShooter.whileHeld(new PneumaticsShooterKick());
        shooterOff = new JoystickButton(driverSecondLayout, 2);
        shooterOff.whenReleased(new ShooterSpin(0));
        shooter = new JoystickButton(driverSecondLayout, 2);
        shooter.whileHeld(new ShooterSpin(2000));
        driveStrightPID = new JoystickButton(driverSecondLayout, 3);
        driveStrightPID.whileHeld(new ArcadeDriveStrightPID());
        shooterSlow = new JoystickButton(driverSecondLayout, 1);
        shooterSlow.whileHeld(new ShooterSpin(-1500));
        ...
        debugForShooterAimPID.whileHeld(new ShooterAimSetpoints(/*90*(debugJoystick.getZ()+1)/2)*/20));
...
//        SmartDashboard.putData("KickBall", new KickBall());
 ...
 //       SmartDashboard.putData("PneumaticsShooterKick", new PneumaticsShooterKick());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        SmartDashboard.putData("VisionLowGoalShot", new VisionLowGoalShot());
    }
