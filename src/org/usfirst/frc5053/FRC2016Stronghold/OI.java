...
public class OI {
    ...
    public JoystickButton shooterKickBtn;
    ...
    public OI() {
        ...
        shooterKickBtn = new JoystickButton(operator, 11);
        shooterKickBtn.whileHeld(new ShooterKickerTemp());
        ...
        armLiftPorticullis.whileHeld(new ArmSetpoints(0.349));
        armGetBall = new JoystickButton(operator, 7);
        armGetBall.whileHeld(new ArmSetpoints(0.327));
        armNeutral = new JoystickButton(operator, 6);
        armNeutral.whileHeld(new ArmSetpoints(0.209));
        kickShooter = new JoystickButton(operator, 12);
        kickShooter.whileHeld(new ShooterKickerTemp());
        ...
        SmartDashboard.putData("ArmSetpoints: GetBall", new ArmSetpoints(0.327));
        SmartDashboard.putData("ArmSetpoints: LiftPorticullis", new ArmSetpoints(0.349));
        ...
        SmartDashboard.putData("ShooterKickerTemp", new ShooterKickerTemp());
        ...
        SmartDashboard.putData("ShooterKickerOff", new ShooterKickerOff());
