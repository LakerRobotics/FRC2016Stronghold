...
//		
//Moved to Constructor        rotationSpeedProfile = new MotionControlHelper(targetAngle, ramp, maxspeed, start, (PIDSource) RobotMap.gyroToUse,new RobotDriveSpinPIDOutput());
//        rotationSpeedPID = new MotionControlPIDController(Kp,Ki,Kd, rotationSpeedProfile );
//    	    rotationSpeedPID.setOutputRange(-1.0, 1.0);
