...
public class CrossRockWall extends CommandGroup {
    ...
    public CrossRockWall(int direction) {

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	
    	addParallel(new ArmSetpoints(ArmSetpoints.AUTON_POSITION));
    	SmartDashboard.putNumber("AutonPotValue", RobotMap.armArmStringPot.get());
    	addParallel(new DriveForward(168.5, 4, 28)); //Distance, speed (ft/sec), ramp/rampdown
