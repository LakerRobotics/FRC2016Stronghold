 ...
 *
 */
public class DriveForwardUltrasonicStop extends Command {
...
double ramp = 0; //inches distance to go from start to maxspeed and maxspeed to 0 at the end
	...
	public DriveForwardUltrasonicStop(double a_distance)
	{
	...
	public DriveForwardUltrasonicStop(double a_distance, double a_maxspeed)
	{
		distance = -a_distance; //TODO we really should not have to negate the value
	...
	public DriveForwardUltrasonicStop(double a_distance, double a_maxspeed, double a_ramp)
	{
		distance = -a_distance;
		maxspeed = a_maxspeed * 12;
		ramp = a_ramp;
  ...
  /*   if(speedFollowerPID.onTarget());
     {
    	...
    	return false; */
    	double distance = RobotMap.ultrasonicTest.pidGet();
    	
    	SmartDashboard.putNumber("UltrasonicTest", RobotMap.ultrasonicTest.pidGet());
