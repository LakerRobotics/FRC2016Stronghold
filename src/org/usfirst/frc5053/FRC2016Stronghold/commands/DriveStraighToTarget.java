...
//    	SmartDashboard.putNumber("IMU_Z_Axis", Robot.imuBoard.getAngleZ());
 ...
 //UseParent   }
	...
	public double getShooterSpeed(double distance) {
		...
		double lowSpeed = 866;  // If shooting close is to low Increase this number.  Take an estimate about how low it is and go to the spreadsheet and is excel goal seek to find the new desired speed that will get the the original heigh t(8.5ft) to the 8.5 + how much it was off by
